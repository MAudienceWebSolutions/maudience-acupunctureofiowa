...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget Area 1', 'twentythirteen' ),
		'id'            => 'sidebar-3',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget Area 2', 'twentythirteen' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
...
$post_type_icon = get_template_directory_uri() . '/images/user--plus.png';
$label = 'Testimonials';
$posttype_name = 'testimonial';
//$taxonomy_name = 'testimonials'; 
...
h1 a {background-image: url(' . get_bloginfo('template_directory') . '/images/logo.png) !important;width: auto !important;height: 100px !important; background-size: 100% !important;}
</style>';
}

add_action('login_head', 'custom_loginlogo');

add_image_size( 'testimonialimg', '361', '272', array('top', 'center') );
